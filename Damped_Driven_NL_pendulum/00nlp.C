...
const double a0=0.00;
const double gam=0.00;
const double w02=1.0;
const double PI=acos(-1.0);
const double m=1.00;

//ofstream prt("nlp020.dat");
ofstream prt("nlp022.dat");
//ofstream prt("nlp0025.dat");
...
//initial conditions
//told=0.0; yold=0.2; vold=0.0;
told=0.0; yold=0.2; vold=2.0;
//told=0.0; yold=0.0; vold=0.25;
